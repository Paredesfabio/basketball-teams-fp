            ...
            <form action="{{ route('team.update',$team->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="profile-top mb-4">
                        <div class="d-flex align-items-center">
                            <div class="profile-image radius-50">
                                <img id="target1" src="{{getImageFile($team->icon)}}" alt="{{ $team->name }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" value="{{ $team->name }}" name="name" class="form-control @error('name') is-invalid @enderror" required>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="division_id"  class="form-select @error('division_id') is-invalid @enderror" required>
                            @foreach ($divisions as $division)
                                <option @selected($division->id == $team->division_id) value="{{ $division->id }}">{{ $division->name }}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12" style="padding-top: 15px;">
                        <button type="submit" class="btn btn-primary">Edit Team Info</button>
                    </div>
                </div>
